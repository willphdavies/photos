...
import * as import18 from './slider.css.ngstyle';
...
var renderType_MdSlider_Host:import11.RenderComponentType = import10.createRenderComponentType('',0,import12.ViewEncapsulation.None,([] as any[]),{});
class View_MdSlider_Host0 extends import9.AppView<any> {
  _el_0:any;
  ...
  constructor(viewUtils:import10.ViewUtils,parentView:import9.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_MdSlider_Host0,renderType_MdSlider_Host,import13.ViewType.HOST,viewUtils,parentView,parentIndex,parentElement,import14.ChangeDetectorStatus.CheckAlways);
  }
  ...
  createInternal(rootSelector:string):import15.ComponentRef<any> {
    this._el_0 = import10.selectOrCreateRenderHostElement(this.renderer,'md-slider',new import10.InlineArray2(2,'tabindex','0'),rootSelector,(null as any));
    this.compView_0 = new View_MdSlider0(this.viewUtils,this,0,this._el_0);
    this._MdSlider_0_3 = new Wrapper_MdSlider(new import16.ElementRef(this._el_0));
    ...
    return new import15.ComponentRef_<any>(0,this,this._el_0,this._MdSlider_0_3.context);
  }
...
export const MdSliderNgFactory:import15.ComponentFactory<import1.MdSlider> = new import15.ComponentFactory<import1.MdSlider>('md-slider',View_MdSlider_Host0,import1.MdSlider);
const styles_MdSlider:any[] = [import18.styles];
var renderType_MdSlider:import11.RenderComponentType = import10.createRenderComponentType('',0,import12.ViewEncapsulation.None,styles_MdSlider,{});
export class View_MdSlider0 extends import9.AppView<import1.MdSlider> {
  _el_0:any;
  _text_1:any;
  _el_2:any;
  _text_3:any;
  ...
  constructor(viewUtils:import10.ViewUtils,parentView:import9.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_MdSlider0,renderType_MdSlider,import13.ViewType.COMPONENT,viewUtils,parentView,parentIndex,parentElement,import14.ChangeDetectorStatus.CheckAlways);
  ...
  createInternal(rootSelector:string):import15.ComponentRef<any> {
    ...
    this._el_0 = import10.createRenderElement(this.renderer,parentRenderNode,'div',new import10.InlineArray2(2,'class','md-slider-track'),(null as any));
    this._text_1 = this.renderer.createText(this._el_0,'\n  ',(null as any));
    this._el_2 = import10.createRenderElement(this.renderer,this._el_0,'div',new import10.InlineArray2(2,'class','md-slider-track-fill'),(null as any));
    this._text_3 = this.renderer.createText(this._el_0,'\n  ',(null as any));
    this._el_4 = import10.createRenderElement(this.renderer,this._el_0,'div',new import10.InlineArray2(2,'class','md-slider-ticks-container'),(null as any));
    this._text_5 = this.renderer.createText(this._el_4,'\n    ',(null as any));
    this._el_6 = import10.createRenderElement(this.renderer,this._el_4,'div',new import10.InlineArray2(2,'class','md-slider-ticks'),(null as any));
    this._text_7 = this.renderer.createText(this._el_4,'\n  ',(null as any));
    this._text_8 = this.renderer.createText(this._el_0,'\n  ',(null as any));
    this._el_9 = import10.createRenderElement(this.renderer,this._el_0,'div',new import10.InlineArray2(2,'class','md-slider-thumb-container'),(null as any));
    this._text_10 = this.renderer.createText(this._el_9,'\n    ',(null as any));
    this._el_11 = import10.createRenderElement(this.renderer,this._el_9,'div',new import10.InlineArray2(2,'class','md-slider-thumb'),(null as any));
    this._text_12 = this.renderer.createText(this._el_9,'\n    ',(null as any));
    this._el_13 = import10.createRenderElement(this.renderer,this._el_9,'div',new import10.InlineArray2(2,'class','md-slider-thumb-label'),(null as any));
    this._text_14 = this.renderer.createText(this._el_13,'\n      ',(null as any));
    this._el_15 = import10.createRenderElement(this.renderer,this._el_13,'span',new import10.InlineArray2(2,'class','md-slider-thumb-label-text'),(null as any));
