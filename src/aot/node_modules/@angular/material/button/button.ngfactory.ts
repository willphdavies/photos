...
import * as import16 from './button.css.ngstyle';
import * as import17 from '../core/ripple/ripple.ngfactory';
...
var renderType_MdButton_Host:import10.RenderComponentType = import9.createRenderComponentType('',0,import11.ViewEncapsulation.None,([] as any[]),{});
class View_MdButton_Host0 extends import8.AppView<any> {
  _el_0:any;
  compView_0:import8.AppView<import1.MdButton>;
  ...
  constructor(viewUtils:import9.ViewUtils,parentView:import8.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_MdButton_Host0,renderType_MdButton_Host,import12.ViewType.HOST,viewUtils,parentView,parentIndex,parentElement,import13.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import14.ComponentRef<any> {
    this._el_0 = import9.selectOrCreateRenderHostElement(this.renderer,'button',new import9.InlineArray2(2,'md-button',''),rootSelector,(null as any));
    ...
    var disposable_0:Function = import9.subscribeToRenderElement(this,this._el_0,new import9.InlineArray8(6,'mousedown',(null as any),'focus',(null as any),'blur',(null as any)),this.eventHandler(this.handleEvent_0));
    this.init(this._el_0,((<any>this.renderer).directRenderer? (null as any): [this._el_0]),[disposable_0]);
    return new import14.ComponentRef_<any>(0,this,this._el_0,this._MdButton_0_3.context);
  }
...
export const MdButtonNgFactory:import14.ComponentFactory<import1.MdButton> = new import14.ComponentFactory<import1.MdButton>('button[md-button], button[md-raised-button], button[md-icon-button], button[md-fab], button[md-mini-fab]',View_MdButton_Host0,import1.MdButton);
const styles_MdButton:any[] = [import16.styles];
class View_MdButton1 extends import8.AppView<any> {
  _el_0:any;
  _MdRipple_0_3:import17.Wrapper_MdRipple;
  /*private*/ _expr_2:any;
  constructor(viewUtils:import9.ViewUtils,parentView:import8.AppView<any>,parentIndex:number,parentElement:any,declaredViewContainer:import18.ViewContainer) {
    super(View_MdButton1,renderType_MdButton,import12.ViewType.EMBEDDED,viewUtils,parentView,parentIndex,parentElement,import13.ChangeDetectorStatus.CheckAlways,declaredViewContainer);
    this._expr_2 = import7.UNINITIALIZED;
  }
  createInternal(rootSelector:string):import14.ComponentRef<any> {
    this._el_0 = import9.createRenderElement(this.renderer,(null as any),'div',new import9.InlineArray8(6,'class','md-button-ripple','md-ripple','','md-ripple-background-color','rgba(0, 0, 0, 0)'),(null as any));
    this._MdRipple_0_3 = new import17.Wrapper_MdRipple(new import15.ElementRef(this._el_0));
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_0_0_1:any = (this.parentView.context.isRoundButton()? 'rgba(255, 255, 255, 0.2)': '');
    ...
    const currVal_2:any = this.parentView.context.isRoundButton();
...
var renderType_MdButton:import10.RenderComponentType = import9.createRenderComponentType('',1,import11.ViewEncapsulation.None,styles_MdButton,{});
export class View_MdButton0 extends import8.AppView<import1.MdButton> {
  _el_0:any;
  _text_1:any;
  _anchor_2:any;
  ...
  _text_3:any;
  constructor(viewUtils:import9.ViewUtils,parentView:import8.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_MdButton0,renderType_MdButton,import12.ViewType.COMPONENT,viewUtils,parentView,parentIndex,parentElement,import13.ChangeDetectorStatus.CheckOnce);
  }
  createInternal(rootSelector:string):import14.ComponentRef<any> {
    const parentRenderNode:any = this.renderer.createViewRoot(this.parentElement);
    this._el_0 = import9.createRenderElement(this.renderer,parentRenderNode,'span',new import9.InlineArray2(2,'class','md-button-wrapper'),(null as any));
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    const currVal_2_0_0:boolean = !this.context._isRippleDisabled();
  ...
  createEmbeddedViewInternal(nodeIndex:number):import8.AppView<any> {
    if ((nodeIndex == 2)) { return new View_MdButton1(this.viewUtils,this,2,this._anchor_2,this._vc_2); }
    return (null as any);
  }
}
var renderType_MdAnchor_Host:import10.RenderComponentType = import9.createRenderComponentType('',0,import11.ViewEncapsulation.None,([] as any[]),{});
class View_MdAnchor_Host0 extends import8.AppView<any> {
  _el_0:any;
  compView_0:import8.AppView<import1.MdAnchor>;
  _MdAnchor_0_3:Wrapper_MdAnchor;
  constructor(viewUtils:import9.ViewUtils,parentView:import8.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_MdAnchor_Host0,renderType_MdAnchor_Host,import12.ViewType.HOST,viewUtils,parentView,parentIndex,parentElement,import13.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import14.ComponentRef<any> {
    this._el_0 = import9.selectOrCreateRenderHostElement(this.renderer,'a',new import9.InlineArray2(2,'md-button',''),rootSelector,(null as any));
    ...
    var disposable_0:Function = import9.subscribeToRenderElement(this,this._el_0,new import9.InlineArray8(8,'mousedown',(null as any),'focus',(null as any),'blur',(null as any),'click',(null as any)),this.eventHandler(this.handleEvent_0));
    this.init(this._el_0,((<any>this.renderer).directRenderer? (null as any): [this._el_0]),[disposable_0]);
    return new import14.ComponentRef_<any>(0,this,this._el_0,this._MdAnchor_0_3.context);
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
...
export const MdAnchorNgFactory:import14.ComponentFactory<import1.MdAnchor> = new import14.ComponentFactory<import1.MdAnchor>('a[md-button], a[md-raised-button], a[md-icon-button], a[md-fab], a[md-mini-fab]',View_MdAnchor_Host0,import1.MdAnchor);
const styles_MdAnchor:any[] = [import16.styles];
class View_MdAnchor1 extends import8.AppView<any> {
  _el_0:any;
  _MdRipple_0_3:import17.Wrapper_MdRipple;
  /*private*/ _expr_2:any;
  constructor(viewUtils:import9.ViewUtils,parentView:import8.AppView<any>,parentIndex:number,parentElement:any,declaredViewContainer:import18.ViewContainer) {
    super(View_MdAnchor1,renderType_MdAnchor,import12.ViewType.EMBEDDED,viewUtils,parentView,parentIndex,parentElement,import13.ChangeDetectorStatus.CheckAlways,declaredViewContainer);
    this._expr_2 = import7.UNINITIALIZED;
  }
  createInternal(rootSelector:string):import14.ComponentRef<any> {
    this._el_0 = import9.createRenderElement(this.renderer,(null as any),'div',new import9.InlineArray8(6,'class','md-button-ripple','md-ripple','','md-ripple-background-color','rgba(0, 0, 0, 0)'),(null as any));
...
var renderType_MdAnchor:import10.RenderComponentType = import9.createRenderComponentType('',1,import11.ViewEncapsulation.None,styles_MdAnchor,{});
export class View_MdAnchor0 extends import8.AppView<import1.MdAnchor> {
  _el_0:any;
  _text_1:any;
  _anchor_2:any;
  /*private*/ _vc_2:import18.ViewContainer;
  ...
  _text_3:any;
  constructor(viewUtils:import9.ViewUtils,parentView:import8.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_MdAnchor0,renderType_MdAnchor,import12.ViewType.COMPONENT,viewUtils,parentView,parentIndex,parentElement,import13.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import14.ComponentRef<any> {
    const parentRenderNode:any = this.renderer.createViewRoot(this.parentElement);
    this._el_0 = import9.createRenderElement(this.renderer,parentRenderNode,'span',new import9.InlineArray2(2,'class','md-button-wrapper'),(null as any));
  ...
  createEmbeddedViewInternal(nodeIndex:number):import8.AppView<any> {
    if ((nodeIndex == 2)) { return new View_MdAnchor1(this.viewUtils,this,2,this._anchor_2,this._vc_2); }
    return (null as any);
  }
}