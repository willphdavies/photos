...
import * as import12 from './toolbar.css.ngstyle';
...
var renderType_MdToolbar_Host:import6.RenderComponentType = import5.createRenderComponentType('',0,import7.ViewEncapsulation.None,([] as any[]),{});
class View_MdToolbar_Host0 extends import4.AppView<any> {
  _el_0:any;
  ...
  constructor(viewUtils:import5.ViewUtils,parentView:import4.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_MdToolbar_Host0,renderType_MdToolbar_Host,import8.ViewType.HOST,viewUtils,parentView,parentIndex,parentElement,import9.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import10.ComponentRef<any> {
    this._el_0 = import5.selectOrCreateRenderHostElement(this.renderer,'md-toolbar',import5.EMPTY_INLINE_ARRAY,rootSelector,(null as any));
...
var renderType_MdToolbar:import6.RenderComponentType = import5.createRenderComponentType('',2,import7.ViewEncapsulation.None,styles_MdToolbar,{});
export class View_MdToolbar0 extends import4.AppView<import1.MdToolbar> {
  _el_0:any;
  _text_1:any;
  _el_2:any;
  ...
  _text_6:any;
  constructor(viewUtils:import5.ViewUtils,parentView:import4.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_MdToolbar0,renderType_MdToolbar,import8.ViewType.COMPONENT,viewUtils,parentView,parentIndex,parentElement,import9.ChangeDetectorStatus.CheckOnce);
  }
  createInternal(rootSelector:string):import10.ComponentRef<any> {
    const parentRenderNode:any = this.renderer.createViewRoot(this.parentElement);
    this._el_0 = import5.createRenderElement(this.renderer,parentRenderNode,'div',new import5.InlineArray2(2,'class','md-toolbar-layout'),(null as any));
    this._text_1 = this.renderer.createText(this._el_0,'\n  ',(null as any));
    this._el_2 = import5.createRenderElement(this.renderer,this._el_0,'md-toolbar-row',import5.EMPTY_INLINE_ARRAY,(null as any));
