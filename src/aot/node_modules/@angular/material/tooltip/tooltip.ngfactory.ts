...
import * as import13 from './tooltip.css.shim.ngstyle';
...
var renderType_TooltipComponent_Host:import8.RenderComponentType = import7.createRenderComponentType('',0,import9.ViewEncapsulation.None,([] as any[]),{});
class View_TooltipComponent_Host0 extends import6.AppView<any> {
  _el_0:any;
  ...
  constructor(viewUtils:import7.ViewUtils,parentView:import6.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_TooltipComponent_Host0,renderType_TooltipComponent_Host,import10.ViewType.HOST,viewUtils,parentView,parentIndex,parentElement,import11.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import12.ComponentRef<any> {
    this._el_0 = import7.selectOrCreateRenderHostElement(this.renderer,'md-tooltip-component',import7.EMPTY_INLINE_ARRAY,rootSelector,(null as any));
...
var renderType_TooltipComponent:import8.RenderComponentType = import7.createRenderComponentType('',0,import9.ViewEncapsulation.Emulated,styles_TooltipComponent,{'state': TooltipComponent_state_factory});
export class View_TooltipComponent0 extends import6.AppView<import1.TooltipComponent> {
  _el_0:any;
  _text_1:any;
  /*private*/ _expr_2:any;
  /*private*/ _expr_3:any;
  /*private*/ _expr_4:any;
  constructor(viewUtils:import7.ViewUtils,parentView:import6.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_TooltipComponent0,renderType_TooltipComponent,import10.ViewType.COMPONENT,viewUtils,parentView,parentIndex,parentElement,import11.ChangeDetectorStatus.CheckAlways);
  ...
  createInternal(rootSelector:string):import12.ComponentRef<any> {
    ...
    this._el_0 = import7.createRenderElement(this.renderer,parentRenderNode,'div',new import7.InlineArray2(2,'class','md-tooltip'),(null as any));
