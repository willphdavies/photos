...
import * as import14 from './progress-bar.css.shim.ngstyle';
...
var renderType_MdProgressBar_Host:import9.RenderComponentType = import8.createRenderComponentType('',0,import10.ViewEncapsulation.None,([] as any[]),{});
class View_MdProgressBar_Host0 extends import7.AppView<any> {
  _el_0:any;
  ...
  constructor(viewUtils:import8.ViewUtils,parentView:import7.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_MdProgressBar_Host0,renderType_MdProgressBar_Host,import11.ViewType.HOST,viewUtils,parentView,parentIndex,parentElement,import12.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import13.ComponentRef<any> {
    this._el_0 = import8.selectOrCreateRenderHostElement(this.renderer,'md-progress-bar',new import8.InlineArray8(6,'aria-valuemax','100','aria-valuemin','0','role','progressbar'),rootSelector,(null as any));
...
var renderType_MdProgressBar:import9.RenderComponentType = import8.createRenderComponentType('',0,import10.ViewEncapsulation.Emulated,styles_MdProgressBar,{});
export class View_MdProgressBar0 extends import7.AppView<import1.MdProgressBar> {
  _text_0:any;
  _el_1:any;
  _text_2:any;
  _el_3:any;
  _NgStyle_3_3:import15.Wrapper_NgStyle;
  _text_4:any;
  _el_5:any;
  _NgStyle_5_3:import15.Wrapper_NgStyle;
  _text_6:any;
  _el_7:any;
  _text_8:any;
  constructor(viewUtils:import8.ViewUtils,parentView:import7.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_MdProgressBar0,renderType_MdProgressBar,import11.ViewType.COMPONENT,viewUtils,parentView,parentIndex,parentElement,import12.ChangeDetectorStatus.CheckOnce);
  }
  createInternal(rootSelector:string):import13.ComponentRef<any> {
    const parentRenderNode:any = this.renderer.createViewRoot(this.parentElement);
    this._text_0 = this.renderer.createText(parentRenderNode,'\n',(null as any));
    this._el_1 = import8.createRenderElement(this.renderer,parentRenderNode,'div',new import8.InlineArray2(2,'class','md-progress-bar-background'),(null as any));
    this._text_2 = this.renderer.createText(parentRenderNode,'\n',(null as any));
    this._el_3 = import8.createRenderElement(this.renderer,parentRenderNode,'div',new import8.InlineArray2(2,'class','md-progress-bar-buffer'),(null as any));
    ...
    this._el_5 = import8.createRenderElement(this.renderer,parentRenderNode,'div',new import8.InlineArray2(2,'class','md-progress-bar-primary md-progress-bar-fill'),(null as any));
    ...
    this._el_7 = import8.createRenderElement(this.renderer,parentRenderNode,'div',new import8.InlineArray2(2,'class','md-progress-bar-secondary md-progress-bar-fill'),(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import18.NgStyle) && (3 === requestNodeIndex))) { return this._NgStyle_3_3.context; }
    if (((token === import18.NgStyle) && (5 === requestNodeIndex))) { return this._NgStyle_5_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
