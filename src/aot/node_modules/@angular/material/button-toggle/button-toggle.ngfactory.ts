...
import * as import15 from './button-toggle.css.ngstyle';
...
var renderType_MdButtonToggle_Host:import9.RenderComponentType = import8.createRenderComponentType('',0,import10.ViewEncapsulation.None,([] as any[]),{});
class View_MdButtonToggle_Host0 extends import7.AppView<any> {
  _el_0:any;
  ...
  constructor(viewUtils:import8.ViewUtils,parentView:import7.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_MdButtonToggle_Host0,renderType_MdButtonToggle_Host,import11.ViewType.HOST,viewUtils,parentView,parentIndex,parentElement,import12.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import13.ComponentRef<any> {
    this._el_0 = import8.selectOrCreateRenderHostElement(this.renderer,'md-button-toggle',import8.EMPTY_INLINE_ARRAY,rootSelector,(null as any));
...
var renderType_MdButtonToggle:import9.RenderComponentType = import8.createRenderComponentType('',1,import10.ViewEncapsulation.None,styles_MdButtonToggle,{});
export class View_MdButtonToggle0 extends import7.AppView<import1.MdButtonToggle> {
  _el_0:any;
  _text_1:any;
  _el_2:any;
  _text_3:any;
  ...
  constructor(viewUtils:import8.ViewUtils,parentView:import7.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_MdButtonToggle0,renderType_MdButtonToggle,import11.ViewType.COMPONENT,viewUtils,parentView,parentIndex,parentElement,import12.ChangeDetectorStatus.CheckAlways);
  ...
  createInternal(rootSelector:string):import13.ComponentRef<any> {
    ...
    this._el_0 = import8.createRenderElement(this.renderer,parentRenderNode,'label',new import8.InlineArray2(2,'class','md-button-toggle-label'),(null as any));
    this._text_1 = this.renderer.createText(this._el_0,'\n  ',(null as any));
    this._el_2 = import8.createRenderElement(this.renderer,this._el_0,'input',new import8.InlineArray2(2,'class','md-button-toggle-input md-visually-hidden'),(null as any));
    this._text_3 = this.renderer.createText(this._el_0,'\n\n  ',(null as any));
    this._el_4 = import8.createRenderElement(this.renderer,this._el_0,'div',new import8.InlineArray2(2,'class','md-button-toggle-label-content'),(null as any));
